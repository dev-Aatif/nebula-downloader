        ...
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center gap-4 mb-4">
            <div className="w-16 h-16 rounded-full bg-neon-blue/20 flex items-center justify-center">
              <HelpIcon className="w-8 h-8 text-neon-blue" />
            </div>
            <div>
              <h1 className="text-4xl font-bold text-text-main">Help & Support</h1>
              <p className="text-text-dim mt-2">Everything you need to get started with Nebula Downloader</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="space-y-6">
            <div className="bg-card/30 border border-border-glass rounded-lg p-6">
              ...
              <ul className="list-disc list-inside space-y-2 text-text-dim ml-4">
                <li>Click the <span className="text-neon-blue">"New File"</span> button in the toolbar</li>
                <li>Paste the URL of the video you want to download</li>
                <li>Select quality options (optional)</li>
                <li>Click "Download" to start</li>
                <li><strong>Keyboard shortcut:</strong> <kbd className="px-2 py-1 bg-white/10 rounded text-xs">Ctrl+N</kbd></li>
              </ul>
            </div>
            ...
            <div className="bg-card/30 border border-border-glass rounded-lg p-6">
              ...
              <ul className="list-disc list-inside space-y-2 text-text-dim ml-4">
                <li><strong>Pause:</strong> Click the pause button to temporarily stop a download</li>
                <li><strong>Resume:</strong> Click the play button to continue a paused download</li>
                <li><strong>Delete:</strong> Click the trash icon to remove a download</li>
                <li><strong>Multi-Select:</strong> Click checkboxes to select multiple downloads for bulk operations</li>
                <li><strong>Show in Folder:</strong> Click the folder icon to open the download location</li>
              </ul>
            </div>
            ...
            <div className="bg-card/30 border border-border-glass rounded-lg p-6">
              ...
              <ul className="list-disc list-inside space-y-2 text-text-dim ml-4">
                <li>Navigate to the <span className="text-neon-blue">"History"</span> page from the sidebar</li>
                ...
                <li><strong>Keyboard shortcut:</strong> <kbd className="px-2 py-1 bg-white/10 rounded text-xs">Ctrl+H</kbd></li>
              </ul>
            </div>
          </div>
        </section>
          ...
          <div className="space-y-4">
            <details className="bg-card/30 border border-border-glass rounded-lg overflow-hidden">
              <summary className="cursor-pointer p-6 font-semibold text-text-main hover:bg-white/5 transition-colors">
                What platforms does Nebula support?
              </summary>
              <div className="px-6 pb-6 text-text-dim">
                Nebula Downloader supports downloads from over 1000 websites including YouTube, Vimeo, Dailymotion, 
                and many more. The app uses yt-dlp under the hood, which provides extensive platform support.
              </div>
            </details>

            <details className="bg-card/30 border border-border-glass rounded-lg overflow-hidden">
              <summary className="cursor-pointer p-6 font-semibold text-text-main hover:bg-white/5 transition-colors">
                How do I change download quality?
              </summary>
              <div className="px-6 pb-6 text-text-dim">
                When adding a new download, you can click "Advanced Options" to select specific quality and format 
                preferences. You can also set a default quality in Settings.
              </div>
            </details>
            ...
            <details className="bg-card/30 border border-border-glass rounded-lg overflow-hidden">
              ...
              <div className="px-6 pb-6 text-text-dim">
                By default, files are saved to your system's Downloads folder. You can change this location in 
                Settings → Download Directory. Use the "Show in Folder" button to quickly open the file location.
              </div>
            </details>
            ...
            <details className="bg-card/30 border border-border-glass rounded-lg overflow-hidden">
              ...
              <div className="px-6 pb-6 text-text-dim space-y-2">
            ...
            <details className="bg-card/30 border border-border-glass rounded-lg overflow-hidden">
              ...
              <div className="px-6 pb-6 text-text-dim">
                Yes! Simply paste a playlist URL, and Nebula will detect it automatically. You'll be prompted 
                to select which videos from the playlist you want to download.
              </div>
            </details>
            ...
            <details className="bg-card/30 border border-border-glass rounded-lg overflow-hidden">
              ...
              <div className="px-6 pb-6 text-text-dim">
                Nebula bundles yt-dlp, but you can manually update it by going to Settings and specifying a 
                custom yt-dlp path. Download the latest version from the official yt-dlp repository.
              </div>
            </details>
          </div>
        </section>
          ...
          <div className="bg-card/30 border border-border-glass rounded-lg overflow-hidden">
            <table className="w-full">
              <thead className="bg-white/5 border-b border-white/10">
                <tr>
                  <th className="text-left p-4 text-sm font-semibold text-text-dim uppercase">Action</th>
                  <th className="text-left p-4 text-sm font-semibold text-text-dim uppercase">Shortcut</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-white/5">
                <tr className="hover:bg-white/5 transition-colors">
                  <td className="p-4 text-text-main">New Download</td>
                  <td className="p-4"><kbd className="px-3 py-1 bg-white/10 rounded text-sm">Ctrl+N</kbd></td>
                </tr>
                <tr className="hover:bg-white/5 transition-colors">
                  <td className="p-4 text-text-main">Open Settings</td>
                  <td className="p-4"><kbd className="px-3 py-1 bg-white/10 rounded text-sm">Ctrl+,</kbd></td>
                </tr>
                <tr className="hover:bg-white/5 transition-colors">
                  <td className="p-4 text-text-main">View History</td>
                  <td className="p-4"><kbd className="px-3 py-1 bg-white/10 rounded text-sm">Ctrl+H</kbd></td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <div className="space-y-4">
            <div className="bg-card/30 border border-border-glass rounded-lg p-6">
              ...
              <div className="space-y-3 text-text-dim">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <strong className="text-text-main">Email Support:</strong> support@nebuladownloader.app
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <span className="w-6 h-6 rounded-full bg-neon-blue/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                  ...
                  <div>
                    <strong className="text-text-main">Documentation:</strong> docs.nebuladownloader.app
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <span className="w-6 h-6 rounded-full bg-neon-blue/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                  ...
                  <div>
                    <strong className="text-text-main">Community:</strong> Join our Discord server for community support
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-r from-neon-blue/10 to-neon-purple/10 border border-neon-blue/30 rounded-lg p-6">
              ...
              <p className="text-text-dim text-sm">
                Found a bug? Please report it on our GitHub repository with detailed steps to reproduce the issue.
              </p>
            </div>
          </div>
        </section>
